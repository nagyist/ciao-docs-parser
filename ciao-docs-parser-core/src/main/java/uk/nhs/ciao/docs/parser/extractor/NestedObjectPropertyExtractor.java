...
/**
 * Properties extractor which returns a single named property composed of properties
 * extracted by a delegate extractor.
 * <p>
 * This results in either a separate Map or List (depending on the {@link DelegationMode}}
 * as the property value, allowing additional hierarchy / namespace to be added to a potentially
